...
<body>
    <div class="container my-5">
        <table class="table">
            ...
            <thead>
                <tr>
                    <th class="col">Numéro de Message </th>
                    <th class="col">nom_client</th>
                    <th class="col">prenom_client</th>
                    <th class="col">email_client</th>
                    <th class="col">Numéro de Téléphone</th>
